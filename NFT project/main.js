...
r1.fromTo('.r1', {opacity: 0, x:125}, {opacity: 1, x:0})
r2.fromTo('.r2', {opacity: 0, x:125}, {opacity: 1, x:0})
r3.fromTo('.r3', {opacity: 0, x:125}, {opacity: 1, x:0})
r4.fromTo('.r4', {opacity: 0, x:125}, {opacity: 1, x:0})
r5.fromTo('.r5', {opacity: 0, x:125}, {opacity: 1, x:0})
r6.fromTo('.r6', {opacity: 0, x:125}, {opacity: 1, x:0})
